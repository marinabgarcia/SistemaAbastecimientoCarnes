...
--
-- Servidor: localhost
-- Tiempo de generación: 07-01-2015 a las 14:53:18
...
ALTER TABLE `precioscompra`
  ...
  ADD CONSTRAINT `preciosVenta-proveedor` FOREIGN KEY (`cuitProveedor`) REFERENCES `proveedor` (`cuitProveedor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
