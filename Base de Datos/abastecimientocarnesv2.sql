...
--
-- Servidor: localhost
-- Tiempo de generación: 20-01-2015 a las 16:39:00
...
--
CREATE DATABASE IF NOT EXISTS `abastecimientocarnes` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `abastecimientocarnes`;
...
(1, 'Nalgaa', NULL, 'Inactivo', 1000, 2),
(2, 'Bife33', NULL, 'Activo', 1033, 4),
(3, 'Lomo', NULL, 'Activo', 43, 1),
(4, 'Lomo', NULL, 'Activo', 345, 5),
(5, 'Solomillo', NULL, 'Activo', 23, 1),
(6, 'Entraña', NULL, 'Activo', 43, 1),
(7, 'Estomágo', NULL, 'Activo', 7, 1),
(8, 'Matambre', NULL, 'Activo', 2, 1),
(9, 'Vacio', NULL, 'Activo', 2, 1),
(10, 'Pata', NULL, 'Activo', 2, 1),
(11, 'Higado', NULL, 'Activo', 34, 1);
...
CREATE TABLE IF NOT EXISTS `compra` (
  ...
  `precioTotalCompraCalculado` double DEFAULT NULL,
  `precioTotalCompra` double DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lineadecompra` (
  ...
  `precioLineaCompra` double DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lineadeventa` (
  ...
  `precioLineaVenta` double DEFAULT NULL,
...
(2, '2015-01-20', NULL, 77, 900.60),
(2, '2015-01-20', NULL, 99, 80.00),
(4, '2015-01-19', NULL, 77, 55.00),
(6, '2015-01-20', NULL, 77, 60.00);
...
CREATE TABLE IF NOT EXISTS `proveedor` (
  ...
  `cuentaCorrienteProveedor` double NOT NULL DEFAULT '0',
...
(77, '7', '7', '7', 332, 4, '7', '7', '77@jfj.com', 'Inactivo', 0),
(99, '888', '88', '88', 332, 4, '88', '88', '', 'Activo', 0);
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `direcciónUsuario` varchar(80) DEFAULT NULL,
...
--
ALTER TABLE `pago`
  ADD CONSTRAINT `pago-compra` FOREIGN KEY (`idTransaccion`) REFERENCES `compra` (`idCompra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `pago-usuario` FOREIGN KEY (`dniUsuario`) REFERENCES `usuario` (`dniUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `pago-ventas` FOREIGN KEY (`idTransaccion`) REFERENCES `venta` (`idVenta`) ON DELETE NO ACTION ON UPDATE NO ACTION;
