<%-- 
    Document   : ImprimirListaC
    Created on : 28/01/2016, 00:02:06
    Author     : FlO
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            JasperDesign _des = JRXmlLoader.load(application.getRealPath("ListaCliente.jrxml"));
             _des.setPageHeight(800);
             _des.setPageWidth(600);
            long tipoCliente = Long.parseLong(request.getAttribute("tipoCliente").toString());
           // String copia=request.getAttribute("copia").toString();
            Map parameters = new HashMap();
            parameters.put("tipoCliente", tipoCliente);
          //  parameters.put("copia", copia);
            JasperReport _rep = JasperCompileManager.compileReport(_des);
          //  JasperFillManager.fillReport(_rep, parameters);
