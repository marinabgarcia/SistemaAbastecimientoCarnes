<%-- 
    Document   : ImprimirLista
    Created on : 27/01/2016, 23:31:20
    Author     : FlO
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            JasperDesign _des = JRXmlLoader.load(application.getRealPath("ListaProveedor.jrxml"));
             _des.setPageHeight(800);
             _des.setPageWidth(600);
            long cuit = Long.parseLong(request.getAttribute("cuit").toString());
           // String copia=request.getAttribute("copia").toString();
            Map parameters = new HashMap();
            parameters.put("cuit", cuit);
