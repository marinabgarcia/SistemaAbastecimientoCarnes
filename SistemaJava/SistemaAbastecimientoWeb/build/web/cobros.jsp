    ...
    <body>
        ...
        <div class="col-lg-10 col-md-10" style=" margin:0px; padding:0px; background-color:rgba(252,252,252,1.00)">
            <div class="col-lg-12 col-md-12" style=" background-color:rgba(249,249,249,1.00); margin:0px; border-bottom:2px inset rgba(227,227,227,1.00); padding:15px; padding-left:25px; margin-bottom:20px;">
                <small>Consultas > <b>Cobros</b></small>
                <h3 style=" color:rgba(235,57,60,1.00)">Listado Cobros Realizados</h3>
            </div>
            ...
            <div class="col-md-3 column" style="margin-bottom: 0px;">
             <button onclick="location.href='venta.jsp'" type="button" role="button" class="btn btn-warning " value="Agregar" style=" height: 110px; min-width: 110px"><span class="fa fa-dollar fa-3x" style=" color: white; display: block;"></span>Registrar Cobro</button>
            </div>
            <div class="col-md-12" style="">
                <div class="table-responsive clearfix">
                    <table id="gridPagos" name="gridPagos" class="table table-hover table-striped" >
                        <thead>
                            <tr>
                                 <th data-column-id="id" data-sortable="false">Id Venta</th>
                                ...
                                <th data-column-id="nombre" data-sortable="false">Nombre Cliente</th>
                                <th data-column-id="razonSocial" data-sortable="false">Razón Social</th>
                                <th data-column-id="cuit" data-sortable="false">Cuit Cliente</th>
                                <th data-column-id="dni" data-sortable="false">DNI Cliente</th>
