 ...
 * @author Marina
 */
public class cargaTablaVentas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cargaTablaVentas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cargaTablaVentas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ventas != null) {
                for (int i = (current - 1) * rowCount; i < ((current * rowCount > ventas.size()) ? ventas.size() : current * rowCount); i++) {
