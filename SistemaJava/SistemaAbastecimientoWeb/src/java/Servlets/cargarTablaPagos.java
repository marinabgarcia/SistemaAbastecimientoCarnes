 ...
 * @author Marina
 */
public class cargarTablaPagos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cargarTablaPagos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cargarTablaPagos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (sortfechaPago != null) {
                sortname = "fechaPago";
                sortorder = sortfechaPago;
            }
            String searchPhrase = request.getParameter("searchPhrase");
            ArrayList<Entidades.Pago> pagos = null;
            pagos = con.getAllPagos(sortname, sortorder, searchPhrase,idTransaccion);
