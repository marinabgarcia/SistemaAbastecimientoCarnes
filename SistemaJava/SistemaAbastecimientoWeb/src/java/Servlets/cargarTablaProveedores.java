 ...
 * @author Marina
 */
public class cargarTablaProveedores extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            ArrayList<Entidades.Proveedor> proveedores;
            proveedores= con.getProveedores(page, rp, sortname, sortorder, query,filtro);
            ...
            if (proveedores != null) {
                for (Entidades.Proveedor proveedor : proveedores) {
                    ...
                    jsonObj.element("cell", proveedor);
                    jArray.add(jsonObj);
                    i++;
                }
            }
            ...
            if (proveedores == null) {
                ...
                jObj.element("total", con.getTotalProveedores(query,filtro).size());
            }
            ...
            Logger.getLogger(cargarTablaProveedores.class.getName()).log(Level.SEVERE, null, ex);
