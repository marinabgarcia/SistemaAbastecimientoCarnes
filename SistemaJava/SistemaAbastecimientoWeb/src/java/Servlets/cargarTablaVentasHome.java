 ...
 * @author Marina
 */
public class cargarTablaVentasHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cargarTablaVentasHome</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cargarTablaVentasHome at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        try {
            ...
            if (ventas != null) {
                for (int i = 0; i < ventas.size(); i++) {
                    ...
                    if (venta.getFechaEntregaVentaS() == null) {
                        seleccion.add(venta);
                    }
